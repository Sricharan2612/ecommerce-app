    ...
    return (
        <section className='flex justify-center items-center mt-10 gap-3 sm:gap-6 flex-wrap px-2 sm:px-0'>
            {serviceData.map((data, index) => (
                <div key={index} className='md:w-[16rem] flex justify-center items-center px-2 py-4 gap-2 rounded-md shrink-0 cursor-pointer hover:scale-[1.1] duration-100' style={{ backgroundColor: `${data.bg}` }}>
